    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-lg-9">
                <div class="content">
                    <h1>Master Program In Supply Chain Management- 11 Months</h1>
                </div>
            </div>
                        ...
                        <ul class="content">
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>Distribution & Logistics Management</li>
...
<div class="row">
    <div class="col-sm-12">
        <ul class="content">
            <li>
                <h4>On completion Master Program in Supply Chain management from BIMT Institute of Business Management, the students achieve a gratifying career such as:</h4>
                <ul>
