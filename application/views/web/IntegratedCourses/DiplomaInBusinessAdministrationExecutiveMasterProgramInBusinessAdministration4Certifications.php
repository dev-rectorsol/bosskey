    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-lg-9">
                <div class="content">
                    <h1>Diploma In Business Administration + Executive Master Program In Business Administration + 4 Certifications</h1>
                </div>
            </div>
            ...
            <div class="tab-pane fade semester active in" role="tabpanel" id="curriculam" aria-labelledby="curriculam-tab">
                ...
                <div class="row">
                    <div class="col-sm-12 txt-block">
                        <h4>Diploma in Business Administration + Executive Master Program in Business Administration + 3 Certification from BIMT Institute of Business Management Distance comprises of 13 core subjects taught under  2 semesters By BIMT India.</h4>
                    </div>
                    <div class="col-sm-4">
                        ...
                        <ul class="content">
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>Excellence in Specialization</li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table course-table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><div class="fee-amt">Rs.21,500</div>
                        </td>
