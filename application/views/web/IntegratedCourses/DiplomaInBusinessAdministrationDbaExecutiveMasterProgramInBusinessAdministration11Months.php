        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9  left-block">
                    ...
                    <p>This Online program is built especially for working managers and professionals to highly focused upon enrollment and certificate programs through our Institute. This program for working professionals from around the globe who are ready to take the next step in their careers & Salary Growth can complete the program from anywhere in the world without interruptions to their career by BIMT India.</p>
                </div>
                <div class="col-md-3 ">
                    <?php echo $courselist;?>
                </div>
            ...
            <div class="tab-pane fade semester active in" role="tabpanel" id="curriculam" aria-labelledby="curriculam-tab">
                ...
                <div class="row">
                    <div class="col-sm-12 txt-block">
                        <h4>Diploma in Business Administration + Executive Master Program in Business Administration Online Certification from BIMT Institute of Business Management comprises of 11 core Education subjects taught under  2 semesters by BIMT India.</h4>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="table-responsive">
                    <table class="table course-table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><div class="fee-amt">Rs.18,500</div>
                        </td>
