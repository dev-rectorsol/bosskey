    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-lg-9">
                <div class="content">
                    <h1>Diploma In Business Administration + Master Program In Business Administration + 3 Certifications -11 Months</h1>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="course-detail clearfix">
                        ...
                        <div class="duration fee clearfix">
                            <div class="detail"> <span>COURSE FEE:</span> Rs.48,000 </div>
                        </div>
            ...
            <div class="tab-pane fade semester active in" role="tabpanel" id="curriculam" aria-labelledby="curriculam-tab">
                ...
                <div class="row">
                    <div class="col-sm-12 txt-block">
                        <h4>Diploma in Business Administration + Master Program in Business Administration + 3 Certification from BIMT Institute of Business Management comprises of 14 Distance core subjects taught under 2 semesters.</h4>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <table class="table course-table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><div class="fee-amt">Rs.48,000</div></td>
                                <td><div class="fee-amt">Rs.48,000</div></td>
                        ...
                        <tr>
                            ...
                            <td><div class="fee-amt">Rs.20,500</div>
                        </td>
                        <td style="border: none;"><div class="fee-amt">Rs.52,000</div>
                    </td>
                </tr>
                <tr>
                    <td><div class="table-col1"> Installment-III (after 1 Month) </div></td>
                    <td><div class="fee-amt">Rs.12,500</div>
                </td>
            </tr>
