    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-lg-9">
                <div class="content">
                    <h1>Executive Program in Business Management -11 Months + 3 Certification</h1>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="course-detail clearfix">
                        ...
                        <div class="duration fee clearfix">
                            <div class="detail"> <span>COURSE FEE:</span> Rs.36,000 </div>
                        </div>
                    ...
                    <table class="table course-table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><div class="fee-amt">Rs.36,000</div></td>
                                <td><div class="fee-amt">Rs.36,000</div></td>
