    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-lg-9">
                <div class="content">
                    <h1>Six Sigma Black Belt Professional</h1>
                </div>
            </div>
            ...
            <div class="tab-pane fade semester active in" role="tabpanel" id="curriculam" aria-labelledby="curriculam-tab">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <ul class="content">
                            <li>
                                <h4>Part V Six Sigma Improve and Control</h4>
                                <ul>
...
<div class="row">
    <div class="col-sm-12">
        <ul class="content">
            <li>
                <h4>Six Sigma Black Belt Professional course is planned to meet the requirements of the following categories of professionals</h4>
                <ul>
