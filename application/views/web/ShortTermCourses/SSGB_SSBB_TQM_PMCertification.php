    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-lg-9">
                <div class="content">
                    <h1>SSGB + SSBB + TQM + PM Certification</h1>
                </div>
            </div>
            ...
            <div class="tab-pane fade semester active in" role="tabpanel" id="curriculam" aria-labelledby="curriculam-tab">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <ul class="content">
                            <li>
                                <h4>Refer the Curriculum of:M</h4>
                                <ul>
                                    <li>Six Sigma Green Belt Professional online Course</li>
                                    <li>Six Sigma Black Belt Professional Course</li>
                                    <li>Total Quality Management Professional Course</li>
                                    <li>Project Management Certification Course</li>
                                </ul>
                            </li>
                        </ul>
                    </div>
