    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-lg-9">
                <div class="content">
                    <h1>Digital Marketing Certification-6 Months</h1>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9  left-block">
                    ...
                    <p><strong><i class="fa fa-arrow-right" aria-hidden="true"></i> COURSE ACCESS DURATION&nbsp;</strong>– 6 Month</p>
                    ...
                    <p ><strong><i class="fa fa-arrow-right" aria-hidden="true"></i> How do I earn the Digital Marketing  Certification:-&nbsp;</strong>Talks about Requirements you will have to fulfill to earn this Certificate.</p>
                ...
                <div class="col-sm-12">
                    <div class="course-detail clearfix">
                        <div class="duration clearfix">
                            ...
                            <div class="detail"> <span>Duration</span> 6 Month </div>
                        </div>
                    ...
                    <table class="table course-table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><div class="fee-amt">N/A</div></td>
                            </tr>
                            <tr>
                                <td><div class="table-col1"> Installment-II (after 1 Month) </div></td>
                                <td><div class="fee-amt">N/A</div></td>
                                <td style="border: none;"><div class="fee-amt">N/A</div></td>
                            </tr>
                            <tr>
