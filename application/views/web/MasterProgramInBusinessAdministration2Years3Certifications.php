    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-lg-9">
                <div class="content">
                    <h1>Master Program In Business Administration- 2 Year + 3 Certifications</h1>
                </div>
            </div>
            ...
            <div class="tab-pane fade semester active in" role="tabpanel" id="curriculam" aria-labelledby="curriculam-tab">
                ...
                <div class="row">
                    <div class="col-sm-12 txt-block">
                        <h4>Master Program in Business Administration- 2 Year + 3 Certification from BIMT Institute of Business Management comprises of 19  core subjects taught under 4 semesters.</h4>
                    </div>
                    <div class="col-sm-3">
                    ...
                    <table class="table course-table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><div class="fee-amt"> Rs.58,000</div></td>
                                <td><div class="fee-amt"> Rs.58,000</div></td>
                        ...
                        <td style="border: none;"><div class="fee-amt">Rs.62,000</div>
                    </td>
                </tr>
                <tr>
                    <td><div class="table-col1"> Installment-III (after 1 Month) </div></td>
                    <td><div class="fee-amt">Rs.22,000</div>
                </td>
            </tr>
