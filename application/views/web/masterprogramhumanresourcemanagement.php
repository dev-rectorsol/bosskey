            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-lg-9">
                        <div class="content">
                            <h1>MASTER PROGRAM IN HUMAN RESOURCE MANAGEMENT- 11 MONTHS</h1>
                        </div>
                    </div>
...
<p ><strong><i class="fa fa-arrow-right" aria-hidden="true"></i> POTENTIAL CAREER GROWTH –&nbsp;</strong>On completion of Master Program in Business Administration achieve a rewarding career by 
                    ...
                    <div class="col-sm-12">
                        <div class="course-detail clearfix">
                            ...
                            <div class="duration fee clearfix">
                                <div class="detail"> <span>COURSE FEE:</span> Rs.29,000 </div>
                            </div>
                                        ...
                                        <table class="table course-table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><div class="fee-amt"> Rs.29,000</div></td>
                                                    <td><div class="fee-amt"> Rs.29,000</div></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><div class="fee-amt">Rs.6,000</div>
                                                       </td>
                                                       <td style="border: none;"><div class="fee-amt">Rs.32,000</div>
                                                       </td>
                                                </tr>
                                ...
                                <div class="tab-pane fade" role="tabpanel" id="semester" aria-labelledby="semester-tab">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <ul class="content">
                                                <li>
                                                    <h4>By completing Master Program in Human resource management from BIMT India,  the students/professionals scope will enhance by:</h4>
                                                    <ul>
                                                        ...
                                                        <li>Enhance ability to understand the financial health of the company to design cost effective hiring strategy</li>
