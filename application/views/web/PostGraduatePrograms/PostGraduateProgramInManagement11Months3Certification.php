    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-lg-9">
                <div class="content">
                    <h1>Post Graduate Program in Management – 11 Months + 3 Certification</h1>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9  left-block">
                    ...
                    <p><strong><i class="fa fa-arrow-right" aria-hidden="true"></i> PROGRAM PLAN</strong> –  Gives in-depth info about what is covered, schedule, different phases involved and Process by BIMT India</p>
                    ...
                    <p>Post Graduate Program in Management with benefits of 3 Online certifications equips students as well as managers with skills to meet the challenges and opportunities of the corporate world. It strengthens the leadership capabilities of students in Distance. The learning model provides a transformational experience that fosters professional, intellectual and personal development. You will also get benefits of 3 certificates provided by BIMT India with this course.</p>
                </div>
                <div class="col-md-3 ">
                     <?php echo $courselist;?>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="course-detail clearfix">
                        ...
                        <div class="duration eligible clearfix">
                            ...
                            <div class="detail"> <span>ELIGIBILITY:</span>Graduation/ Diploma in any discipline or equivalent with minimum 3 Year of working experience.</div>
                        </div>
                        <div class="duration fee clearfix">
                            <div class="detail"> <span>COURSE FEE:</span> Rs.32,000 </div>
                        </div>
                    ...
                    <div class="col-sm-4">                        
                        <ul class="content">
                            <li>                                
                                ...
                                <ul>
                                    <li>Six Sigma Green Belt Professional</li>
                    ...
                    <table class="table course-table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><div class="fee-amt"> Rs.32,000</div></td>
                                <td><div class="fee-amt"> Rs.32,000</div></td>   
                            </tr>
                            <tr>
                                <td><div class="table-col1"> Installment-I </div></td>
                                <td><div class="fee-amt">Rs.16,000</div>
                            </td>
                            </tr>
                            <tr>
                            ...
                            <td style="border: none;"><div class="fee-amt">Rs.36,000</div>
                        </td>
                    </tr>
                    <tr>
...
<div class="row">
    <!-- <div class="col-sm-12">
        <ul class="content">
            <li>
                <p>The global management firm McKinsey & Company recently reported a projected shortage of 140,000 to 190,000 data scientists by 2018. This represents a 50-to- 60% talent gap to meet projected demands. For IT managers and other business leaders looking to break into this career path, a strong foundation of skill-based training and a working knowledge of key software tools may be beneficial to professionals looking to secure a quality position in this competitive field.</p>
            </li>
        </ul>
    </div> -->
