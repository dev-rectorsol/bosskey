    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-lg-9">
                <div class="content">
                    <h1>Master Program In Business Administration + 3 Certifications-11 Months</h1>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="course-detail clearfix">
                        ...
                        <a href="http://localhost/bosssky/onlineapply" class="btn">apply now <span class="icon-more-icon"></span></a> </div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="tab-pane fade semester active in" role="tabpanel" id="curriculam" aria-labelledby="curriculam-tab">
                ...
                <div class="row">
                    <div class="col-sm-12 txt-block">
                        <h4>Online Master Program in International Business from BIMT comprises of 8 core subjects taught under 2 semesters.</h4>
                    </div>
                    <div class="col-sm-6">
...
<div class="row payment-instr">
    <div class="col-sm-12">
        <div class="content">
            ...
            <ul>
                <li> Fees need to be paid in lump sum / first Installment via Demand Draft (DD) or online payment in favor of "IIBM Institute of Business Management".</li>
        ...
        <ul class="content">
            <li>
                ...
                <ul>
                    ...
                    <li>Enhance knowledge in International Trade & Export Import Management by IIBM India</li>
                </ul>
            </li>
        </ul>
    </div>
...
<div class="row">
    <div class="col-sm-12">
        <ul class="content">
            <li>
                <h4>On completion of Master Program in International Business  from IIBM Institute, the students achieve a satisfying career growth by BIMT India such as:</h4>
                <ul>
