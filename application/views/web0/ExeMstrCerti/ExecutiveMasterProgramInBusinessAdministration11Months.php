    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-lg-9">
                <div class="content">
                    <h1>Executive Master Program In Business Administration- 11 Months</h1>
                </div>
            </div>
                    ...
                    <div class="course-detail clearfix">
                        ...
                        <div class="duration eligible clearfix">
                          <div class="icon"><span class="fa fa-list"></span></div>
                            <div class="detail"> <span>ELIGIBILITY:</span>Fresh Graduates/ Fresh Graduates/ Diploma in any discipline or equivalent with minimum 3 Year of working Professionals. </div>
                        </div>
                        <div class="duration fee clearfix">
                            <div class="detail"> <span>COURSE FEE:</span> Rs.42,000 </div>
                        </div>
            ...
            <div class="tab-pane fade semester active in" role="tabpanel" id="curriculam" aria-labelledby="curriculam-tab">
                ...
                <div class="row">
                    <div class="col-sm-12 txt-block">
                        <h4>Executive Master Program in Business Administration Certification from BIMT Institute of Business Management comprises of  10 core subjects taught under 2 semesters.</h4>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <table class="table course-table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><div class="fee-amt"> Rs.42,000</div></td>
                                <td><div class="fee-amt"> Rs.42,000</div></td>
                        ...
                        <td style="border: none;"><div class="fee-amt">Rs.46,000</div>
                    </td>
                </tr>
                <tr>
                    <td><div class="table-col1"> Installment-III (after 1 Month) </div></td>
                    <td><div class="fee-amt">Rs.11,000</div>
                </td>
            </tr>
