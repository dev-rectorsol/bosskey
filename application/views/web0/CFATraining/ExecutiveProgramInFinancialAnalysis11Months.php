    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-lg-9">
                <div class="content">
                    <h1>Executive Program in Financial Analysis-11 Months</h1>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="course-detail clearfix">
                        ...
                        <div class="duration eligible clearfix">
                            ...
                            <div class="detail"> <span>ELIGIBILITY:</span>Graduate or equivalent</div>
                        </div>
                        ...
                        <ul class="content">
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>Investments Analysis and Behaviour</li>
                                </ul>
                            </li>
