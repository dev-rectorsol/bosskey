    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-lg-9">
                <div class="content">
                    <h1>Diploma In Business Administration-6 Months</h1>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="course-detail clearfix">
                        ...
                        <div class="duration fee clearfix">
                            <div class="detail"> <span>COURSE FEE:</span> Rs.16,000 </div>
                        </div>
            ...
            <div class="tab-pane fade semester active in" role="tabpanel" id="curriculam" aria-labelledby="curriculam-tab">
                ...
                <div class="row">
                    <div class="col-sm-12 txt-block">
                        <h4>Diploma in Business Administration  from BIMT Institute of Business Management comprises of 4 core subjects in Distance taught under 1 semester.</h4>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <table class="table course-table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><div class="fee-amt"> Rs.16,000</div></td>
                                <td><div class="fee-amt"> Rs.16,000</div></td>
        ...
        <ul class="content">
            <li>
                ...
                <ul>
                    ...
                    <li>Department stores supervisor</li>
                    <li>Retail store supervisor</li>
                    <li>School Administrative coordinator</li>
