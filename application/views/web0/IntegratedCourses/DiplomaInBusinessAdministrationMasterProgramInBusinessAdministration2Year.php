    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-lg-9">
                <div class="content">
                    <h1>Diploma In Business Administration + Master Program In Business Administration – 2 Year</h1>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="course-detail clearfix">
                        ...
                        <div class="duration fee clearfix">
                            <div class="detail"> <span>COURSE FEE:</span> Rs.56,000 </div>
                        </div>
            ...
            <div class="tab-pane fade semester active in" role="tabpanel" id="curriculam" aria-labelledby="curriculam-tab">
                ...
                <div class="row">
                    <div class="col-sm-12 txt-block">
                        <h4>Diploma in Business Administration + Master Program in Business Administration 2 Year Certification from BIMT Institute of Business Management comprises of 16 core subjects taught under 4 semesters by BIMT India.</h4>
                    </div>
                    <div class="col-sm-3">
                    ...
                    <table class="table course-table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><div class="fee-amt">Rs.56,000</div></td>
                                <td><div class="fee-amt">Rs.56,000</div></td>
