    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-lg-9">
                <div class="content">
                    <h1>Six Sigma Black Belt Professional + Total Quality Management Professional</h1>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9  left-block">
                    ...
                    <p>Total Quality Management Online Professional is the organization-wide management of quality. Management consists of planning, organizing, directing, control, and assurance. Online Total quality by BIMT India is called total because it consists of two qualities: quality of return to satisfy the needs of the shareholders, and quality of products.</p>
                </div>
                <div class="col-md-3 ">
                    <?php echo $courselist;?>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="course-detail clearfix">
                        ...
                        <div class="duration eligible clearfix">
                            ...
                            <div class="detail"> <span>ELIGIBILITY:</span>10+2</div>
                        </div>
                    ...
                    <div class="col-sm-4">
                        <ul class="content">
                            <li>
                                ...
                                <ul>
                                    <li>Introduction to Quality Management</li>
                                    <li>Concept of Quality</li>
                                    <li>Customer Retention</li>
                                    <li>Concept of Quality Circle</li>
                                    <li>Total Quality through Japanese 5-S</li>
                                    <li>Statistical Process Control</li>
                                    <li>Process Capability and Six sigma</li>
                                    <li>Tools and Techniques for Quality Management</li>
                                    <li>The Seven Tools of  TQM</li>
                                    <li>ISO Concept</li>
