                ...
                <div class="col-sm-12">
                    <div class="course-detail clearfix">
                        <div class="duration clearfix">
                            ...
                            <div class="detail"> <span>Duration</span> 4 Months </div>
                        </div>
                        ...
                        <ul class="content">
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>Examining the Project Process</li>
                                    <li>Managing Project Integration</li>
                                    <li>Managing the Project Scope</li>
                                    <li>Managing Project Time</li>
                                    <li>Managing Project Costs</li>
                                    <li>Managing Project Quality</li>
                                    <li>Managing Project development</li>
                                    <li>Managing Project Human Resources</li>
                                    <li>Managing Project Communications</li>
                                    <li>Managing Project Risks</li>
                                    <li>Introducing Project Procurement Management</li>
                                </ul>
                            </li>
                        </ul>
                    </div>
